...
namespace Aqt.CoreFW.Migrations
{
    ...
    [Migration("20250505025017_Add_Component_Document_Entity")]
    partial class Add_Component_Document_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.AccountTypes.Entities.AccountType", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("SyncRecordCode")
                        .HasMaxLength(50)
                        .HasColumnType("NVARCHAR2(50)")
                        .HasColumnName("SyncRecordCode");

                    b.Property<Guid?>("SyncRecordId")
                        .HasColumnType("RAW(16)")
                        .HasColumnName("SyncRecordId");

                    b.HasKey("Id");

                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppAccountTypes_Code");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_AppAccountTypes_Name");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_AppAccountTypes_Status");

                    b.HasIndex("Order", "Name")
                        .HasDatabaseName("IX_AppAccountTypes_Order_Name");
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.BDocuments.Entities.BDocument", b =>
                {
                    ...
                    b.Property<string>("ApplicantIdentityNumber")
                        .HasMaxLength(50)
                        .HasColumnType("NVARCHAR2(50)")
                        .HasColumnName("ApplicantIdentityNumber");
                    ...
                    b.Property<string>("ApplicantPhoneNumber")
                        ...
                        .HasColumnName("ApplicantPhoneNumber");
                    ...
                    b.Property<bool>("ReceiveByPost")
                        .HasColumnType("BOOLEAN")
                        .HasColumnName("ReceiveByPost");

                    b.Property<DateTime?>("ReceptionDate")
                        .HasColumnType("TIMESTAMP(7)")
                        .HasColumnName("ReceptionDate");

                    b.Property<string>("RejectionOrAdditionReason")
                        .HasMaxLength(1000)
                        .HasColumnType("NVARCHAR2(1000)")
                        .HasColumnName("RejectionOrAdditionReason");

                    b.Property<DateTime?>("ResultDate")
                        .HasColumnType("TIMESTAMP(7)")
                        .HasColumnName("ResultDate");

                    b.Property<string>("ScopeOfActivity")
                        .HasColumnType("NVARCHAR2(2000)")
                        .HasColumnName("ScopeOfActivity");
                    ...
                    b.HasIndex("ApplicantName")
                        .HasDatabaseName("IX_AppBDocuments_ApplicantName");

                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppBDocuments_Code");
                    ...
                    b.HasIndex("ReceiveByPost")
                        .HasDatabaseName("IX_AppBDocuments_ReceiveByPost");

                    b.HasIndex("WorkflowStatusId")
                        .HasDatabaseName("IX_AppBDocuments_WorkflowStatusId");

                    b.HasIndex("ProcedureId", "WorkflowStatusId", "CreationTime")
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.Components.Entities.ProcedureComponent", b =>
                {
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppProcedureComponents_Code");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_AppProcedureComponents_Name");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_AppProcedureComponents_Status");

                    b.HasIndex("Type")
                        .HasDatabaseName("IX_AppProcedureComponents_Type");

                    b.HasIndex("Status", "Type", "Order", "Name")
                        .HasDatabaseName("IX_AppProcedureComponents_Status_Type_Order_Name");

                    b.ToTable("AppProcedureComponents", (string)null);
                });

            modelBuilder.Entity("Aqt.CoreFW.Domain.Components.Entities.ProcedureComponentLink", b =>
                {
                    b.Property<Guid>("ProcedureId")
                        .HasColumnType("RAW(16)");
                    ...
                    b.HasKey("ProcedureId", "ProcedureComponentId");

                    b.HasIndex("ProcedureComponentId")
                        .HasDatabaseName("IX_AppProcedureComponentLinks_ProcedureComponentId");

                    b.HasIndex("ProcedureId")
                        .HasDatabaseName("IX_AppProcedureComponentLinks_ProcedureId");

                    b.ToTable("AppProcedureComponentLinks", (string)null);
                });
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.DataCores.Entities.DataCore", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("RAW(16)");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppDataCores_Code");

                    b.HasIndex("DataGroupId")
                        .HasDatabaseName("IX_AppDataCores_DataGroupId");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_AppDataCores_Name");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_AppDataCores_Status");

                    b.HasIndex("DataGroupId", "Status", "Order", "Name")
                        .HasDatabaseName("IX_AppDataCores_DataGroupId_Status_Order_Name");

                    b.ToTable("AppDataCores", (string)null);
                });

            modelBuilder.Entity("Aqt.CoreFW.Domain.DataGroups.Entities.DataGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("RAW(16)");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppDataGroups_Code");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_AppDataGroups_Name");

                    b.HasIndex("ParentId")
                        .HasDatabaseName("IX_AppDataGroups_ParentId");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_AppDataGroups_Status");

                    b.HasIndex("ParentId", "Status", "Order", "Name")
                        .HasDatabaseName("IX_AppDataGroups_ParentId_Status_Order_Name");

                    b.ToTable("AppDataGroups", (string)null);
                });

            modelBuilder.Entity("Aqt.CoreFW.Domain.DataImportants.Entities.DataImportant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("RAW(16)");
                    ...
                    b.HasIndex("DataGroupId")
                        .HasDatabaseName("IX_AppDataImportants_DataGroupId");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_AppDataImportants_Name");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_AppDataImportants_Status");

                    b.HasIndex("DataGroupId", "Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppDataImportants_DataGroupId_Code");

                    b.HasIndex("DataGroupId", "Status", "Order", "Name")
                        .HasDatabaseName("IX_AppDataImportants_DataGroupId_Status_Order_Name");

                    b.ToTable("AppDataImportants", (string)null);
                });
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.Procedures.Entities.Procedure", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("RAW(16)");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppProcedures_Code");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_AppProcedures_Name");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_AppProcedures_Status");

                    b.HasIndex("SyncRecordCode")
                        .HasDatabaseName("IX_AppProcedures_SyncRecordCode");

                    b.HasIndex("Status", "Order", "Name")
                        .HasDatabaseName("IX_AppProcedures_Status_Order_Name");

                    b.ToTable("AppProcedures", (string)null);
                });
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.Provinces.Entities.Province", b =>
                {
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppProvinces_Code");

                    b.HasIndex("CountryId")
                        .HasDatabaseName("IX_AppProvinces_CountryId");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_AppProvinces_Status");

                    b.HasIndex("CountryId", "Name")
                        .IsUnique()
                        .HasDatabaseName("IX_AppProvinces_CountryId_Name");

                    b.HasIndex("CountryId", "Order", "Name")
                        .HasDatabaseName("IX_AppProvinces_CountryId_Order_Name");

                    b.ToTable("AppProvinces", (string)null);
                });

            modelBuilder.Entity("Aqt.CoreFW.Domain.Ranks.Entities.Rank", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("RAW(16)");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppRanks_Code");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_AppRanks_Name");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_AppRanks_Status");

                    b.HasIndex("Status", "Order", "Name")
                        .HasDatabaseName("IX_AppRanks_Status_Order_Name");

                    b.ToTable("AppRanks", (string)null);
                });

            modelBuilder.Entity("Aqt.CoreFW.Domain.WorkflowStatuses.Entities.WorkflowStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("RAW(16)");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_AppWorkflowStatuses_Code");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_AppWorkflowStatuses_IsActive");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("IX_AppWorkflowStatuses_Name");

                    b.HasIndex("Order", "Name")
                        .HasDatabaseName("IX_AppWorkflowStatuses_Order_Name");
            ...
            modelBuilder.Entity("EasyAbp.FileManagement.Users.FileUser", b =>
                {
                    ...
                    b.ToTable("AppFileUsers", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.OrganizationUnit", b =>
                {
                    ...
                    b.Property<string>("SyncRecordId")
                        .HasMaxLength(100)
                        .HasColumnType("NVARCHAR2(100)")
                        .HasColumnName("SyncRecordId");
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.BDocuments.Entities.BDocument", b =>
                {
                    ...
                    b.HasOne("Aqt.CoreFW.Domain.WorkflowStatuses.Entities.WorkflowStatus", "WorkflowStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.Components.Entities.ProcedureComponentLink", b =>
                {
                    b.HasOne("Aqt.CoreFW.Domain.Components.Entities.ProcedureComponent", null)
                        .WithMany("ProcedureLinks")
                        .HasForeignKey("ProcedureComponentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.DataCores.Entities.DataCore", b =>
                {
                    b.HasOne("Aqt.CoreFW.Domain.DataGroups.Entities.DataGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Aqt.CoreFW.Domain.Provinces.Entities.Province", b =>
                {
                    b.HasOne("Aqt.CoreFW.Domain.Countries.Entities.Country", null)
                        .WithMany()
